...
-- The expression below is not immutable on newer PostgreSQL versions, so it is omitted here.
-- CREATE INDEX idx_visits_user_landmark_day
--     ON visits (user_id, landmark_id, ((created_at AT TIME ZONE 'UTC')::DATE));
